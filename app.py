...
"ODS 7":[
    ...
    {
        "name": "7.3 Número de iniciativas de inovação tecnológica em eficiência energética",
        "options": [
    ...
    {
        "name": "7.4 Percentual de energia renovável contratada e produzida em instalações portuárias",
        "options": [
    ...
    {
        "name": "7.5 Percentual de biocombustíveis em cargas elétricas e mecânicas",
        "options": [
    ...
    {
        "name": "7.6 Número de iniciativas de inovação tecnológica em energia renovável",
        "options": [
            "0: Nenhuma iniciativa.",
    ...
    {
        "name": "7.7 Diversidade de fontes de energia renovável em instalações portuárias",
        "options": [
    ...
    {
        "name": "7.8 Quantidade de parcerias para promoção de energia limpa",
        "options": [
    ...
    {
        "name": "7.9 Quantidade de estações de carregamento para veículos elétricos",
        "options": [
    ...
    {
        "name": "7.10 Percentual de fornecimento de energia renovável para navios",
        "options": [
    ...
    {
        "name": "7.11 Percentual de abastecimento com GNL",
        "options": [
...
"ODS 13": [
    {
        "name": "13.1 Status do Plano de Estratégia para Mudança Climática",
        "options": [
    ...
    {
        "name": "13.2 Inventário de Emissões",
        "options": [
    ...
    {
        "name": "13.3 Programa de Gestão de Créditos de Carbono",
        "options": [
    ...
    {
        "name": "13.5 Número de Colaborações e Parcerias para Ação Climática",
        "options": [
    ...
    {
        "name": "13.8 Percentual de Redução de Emissões por Meio da Implementação de Novas Tecnologias",
        "options": [
